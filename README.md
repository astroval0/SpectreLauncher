This launcher has been rewritten and moved to a new repository:
- https://github.com/SpectreRevival/SpectreLauncher

~~Download the latest release [here](https://github.com/astroval0/SpectreLauncher/releases)~~
